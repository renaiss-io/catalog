...
```
If you want to know how to host Prometheus locally with docker and exposing it as a data source using ngrok please refer to this [doc](/docs/prometheus.md)
